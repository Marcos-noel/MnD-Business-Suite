...
class AuthService(BaseService):
    ...
    async def _ensure_global_permissions(self) -> None:
        ...
        required = [
            ...
            ("crm.read", "View CRM"),
            ("crm.quote.manage", "Create and manage CRM quotes"),
            ("crm.social.manage", "Manage CRM social interactions"),
            ("crm.activity.read", "View CRM audit activity"),
            ("commerce.manage", "Manage e-commerce orders"),
            ("commerce.read", "View e-commerce data"),
            ("commerce.write", "Manage e-commerce data"),
            ("analytics.read", "View analytics dashboards"),
            ("finance.manage", "Manage finance"),
            ("finance.read", "View finance data"),
            ("finance.write", "Manage finance data"),
            ("export.manage", "Manage exports"),
            ("export.read", "View exports"),
            ("export.write", "Manage exports"),
